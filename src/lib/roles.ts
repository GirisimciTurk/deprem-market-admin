...
export const ADMIN_ONLY_PATHS = ['/settings', '/promotions', '/customers', '/resellers', '/havar-requests', '/service-requests', '/sellers', '/seller-scorecards', '/seller-campaigns', '/seller-reviews', '/seller-contracts', '/commission-rules', '/cargo-tariff', '/categories', '/category-attributes', '/brands', '/product-approvals', '/invoices']
